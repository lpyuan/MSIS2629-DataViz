...
In the future improvement, instead of only focus on the US, I will generate more data of different countries. As only with more comparisons with the rest of the worlds will make the unique problems in the US more standout.
